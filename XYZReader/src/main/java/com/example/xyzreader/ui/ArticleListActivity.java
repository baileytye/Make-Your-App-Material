    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(view1 -> {
                ...
                startActivity(intent, Objects.requireNonNull(bundle).toBundle());
            });
            return vh;
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                holder.thumbnailView.setTransitionName(mContext.getString(R.string.transition_name) + position);
            }
            mArticlePosition = position;
            holder.thumbnailView.setTag(mContext.getString(R.string.transition_name) + position);
            ...
            ImageLoader loader = ImageLoaderHelper.getInstance(ArticleListActivity.this).getImageLoader();
            ...
            loader.get(image, new ImageLoader.ImageListener() {
                ...
                public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                    ...
                    if (bitmap != null) {
                        ...
                        holder.cardLayout.setBackgroundColor(ColorUtils.blendARGB(mMutedColor, Color.BLACK, 0.0f));
                    }
                }
